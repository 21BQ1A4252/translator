...
df = pd.read_csv("C://Users//91799//OneDrive//Documents//data.csv")
print(df.shape)
...
print(plt.plot(history1.history["mean_squared_error"],color="blue"))
print(plt.plot(history1.history["val_loss"],color="red"))
print(plt.plot(history2.history["val_loss"],color="yellow"))
